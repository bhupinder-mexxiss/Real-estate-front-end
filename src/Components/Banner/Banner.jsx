...
const Banner = () => {
  return (
    <>
      ...
      <div className="relative z-0 mt-[-60px] sm:mt-[-66px] md:mt-[-78px] lg:-mt-10 xl:-mt-14 seachTab">
          ...
          <div className="p-3 sm:p-5 lg:px-7 lg:py-3 xl:py-5 bg-white rounded-xl lg:rounded-full max-w-[1026px] mx-auto">
            <div className=" lg:flex gap-2 xl:gap-3 items-center justify-between">
              <div className="flex flex-wrap xs:flex-nowrap lg:justify-between lg:w-full gap-1.5 xs:gap-2 xl:gap-3 mb-3 lg:mb-0">
                <button className="py-1.5 md:py-2 lg:py-[15px] lg:w-full text-nowrap px-4 md:px-8 lg:px-5 rounded-xl  sm:rounded-3xl md:rounded-full bg-primary border border-primary text-white text-sm xs:text-base md:text-lg xl:text-[22px] font-medium">
                  Rent
                </button>
                <button className="py-1.5 md:py-2 lg:py-[15px] lg:w-full text-nowrap px-4 md:px-8 lg:px-5 rounded-xl  sm:rounded-3xl md:rounded-full border border-border1 hover:border-primary text-text2 hover:text-primary text-sm xs:text-base md:text-lg xl:text-[22px] font-normal">
                  Buy
                </button>
                <button className="py-1.5 md:py-2 lg:py-[15px] lg:w-full text-nowrap px-4 md:px-8 lg:px-5 rounded-xl  sm:rounded-3xl md:rounded-full border border-border1 hover:border-primary text-text2 hover:text-primary text-sm xs:text-base md:text-lg xl:text-[22px] font-normal">
                  New Project
              ...
              <div className="py-1.5 md:py-2 pl-3 md:pl-5 pr-2 md:pr-3 rounded-full border border-border1 hover:border-primary relative hover:text-primary flex">
                <input
                  type="text"
                  className="lg:w-auto w-full border-none ring-0 focus:ring-0 text-text2 text-sm xs:text-base md:text-lg xl:text-[22px] font-normal px-0 py-0 leading-4 md:leading-8 placeholder:text-text2"
                  placeholder="Search"
                />
