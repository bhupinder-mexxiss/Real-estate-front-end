    ...
    <div className="newProject sm:pb-16 py-12 sm:pt-20">
      <div className="container mx-auto">
        ...
        <div className="text-center">
          <button className="border border-border1 rounded-full py-2 sm:py-3 md:py-[15px] px-8 sm:px-11 text-base sm:text-lg md:text-[22px] text-text2 inline-block hover:border-primary hover:bg-primary hover:text-white duration-300">
