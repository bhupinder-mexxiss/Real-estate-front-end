          ...
          <div className="pb-8 pt-4 xs:pb-11 sm:pb-16 md:pb-20 lg:pb-[120px] relative overflow-hidden">
            <div className="xs:flex flex-wrap pb-4 sm:pb-10 lg:pb-14 border-b-[1.6px] border-border1">
              <div className="w-full xs:w-1/2 lg:w-[30%] 2xl:w-1/4 mb-5 xs:mb-0">
                ...
                <div>
                  <p className="text-sm sm:text-base md:text-lg text-text2">
                    +152 78457349587
                  </p>
                  <p className="text-sm sm:text-base md:text-lg text-text2">
                    property@gmail.com
              ...
              <div className="w-full xs:w-1/2 lg:w-2/5 2xl:w-1/2 2xl:px-36 xl:pl-24 xl:pr-16 lg:pl-14 lg:pr-12 md:pl-20 sm:pl-10 xs:pl-6 xs:pr-4 ">
                <ul className="grid grid-rows-5 grid-flow-col *:duration-300 xs:justify-between">
                  <li className="hover:translate-x-1 mb-2 xs:mb-3 md:mb-4 lg:mb-6">
                    <Link className="text-sm sm:text-base md:text-lg text-text2 *:duration-300 hover:text-primary">
                      Home
                    </Link>
                  </li>
                  <li className="hover:translate-x-1 mb-2 xs:mb-3 md:mb-4 lg:mb-6">
            ...
            <div className="text-center absolute w-full">
              <h4 className="text-[36px] xs:text-[48px] sm:text-[68px] md:text-[90px] lg:text-[130px] uppercase text-primary opacity-[8%]">
                REAL ESTATE
              </h4>
            </div>
          </div>
