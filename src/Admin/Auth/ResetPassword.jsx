            ...
            <div className="md:w-[55%] lg:min-w-[530px] xl:min-w-[630px] pt-8 pb-10 sm:py-14 sm:px-6 md:px-16 xl:px-24 flex items-center md:min-h-screen relative md:bg-white md:rounded-l-[40px] ov">
              <div className="bg-white py-8 px-4 sm:p-8 rounded-lg md:p-0 w-full">
                <div className="mb-6 sm:mb-110">
                  ...
                  <p className="text-sm text-[#8B8B8B] mb-8">Enter your email. We will email intructions on how to reset your password.</p>
                  <div className=" mb-8">
                  ...
                  <Link to="/admin/reset-password/send-link" className="text-center mb-4 font-medium text-white bg-primary rounded-full py-3.5 px-6 block w-full">
                  Send Reset Email
                  </Link>
